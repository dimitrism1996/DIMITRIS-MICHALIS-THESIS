...
\input{chapters/off_line}
%-------------------------------------------------------

\chapter{MAEAs with on-line training}
\input{chapters/on_line}
%--------------------------------------------------------

\chapter{Surrogate Models}
\input{chapters/surrogate_models}

\chapter{Numerical Cases}
\input{chapters/numerical_cases}

\chapter{Airfoil Shape Optimization}
\input{chapters/airfoil}
...
%\input{chapters/steepest_descent}
%\newpage
%--------------------------------------------------
...
\\
\hline
\textbf{Αέρας} & 0.364805 & 0.227 & 216.8 \\
\bottomrule
\end{tabular}%
}
